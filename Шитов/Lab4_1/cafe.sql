...
--
-- Хост: localhost:8889
-- Время создания: Апр 26 2023 г., 10:55
...
CREATE TABLE `admin` (
  ...
  `Логин_админа` varchar(255) NOT NULL,
  `Пароль_админа` varchar(255) NOT NULL
...
INSERT INTO `admin` (`id_admin`, `Логин_админа`, `Пароль_админа`) VALUES
(1, 'admin', '123456');
...
(11, 'Шитов Григорий', 'shitov@gmail.com', 'shitov', '1234', '+79054430723', '2023-04-07 14:26:51');
...
(4, 11, 2, '2023-04-07 14:28:01', NULL),
(5, 11, 8, '2023-04-07 14:28:01', NULL);
...
(1, 'Свердлюченко', 'Алексей', 'Владимирович', '+79045423422', '4134 678021', 4, 7),
...
--
ALTER TABLE `Клиент`
  MODIFY `ID_Клиента` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `Событие`
  MODIFY `id_события` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
