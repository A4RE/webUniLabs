...
<div class="container obr_svyaz">
    <div class="row justify-content-center form-obr-svaz col-md-12 col-12">
        ...
        <div class="col-12 col-md-6">
            <p style="padding-left: 30px">
                <b>Если вы хотите заказать столик, в одном из наших кафе, то можете:<br>
                    1. позвонить по телефону: +79043440722 <br>
                    2. Заполнить форму ниже, в теме письма указав - Закать столик, а в сообщении укзать адрес кафе, время, количество персон<br>
                    Мы пришлем ответ в течении пары часов.
                </b>
            </p>
        </div>
        <div class="col-12 col-md-6">
    ...
    <?php
    if(isset($_POST['send'])){
        mail($_POST['theme'], $_POST['email'], $_POST['msg'], 'From: shitov@gmail.com');
