...
--
-- Хост: localhost:8889
-- Время создания: Апр 04 2023 г., 18:09
...
INSERT INTO `Дом` (`id_дома`, `Кол_этажей`, `Цена`, `id_макета`) VALUES
(1, 2, '4000000.00', 1),
(2, 1, '2300000.00', 2),
(3, 1, '1500000.00', 4),
(4, 3, '5500000.00', 3);
...
INSERT INTO `Клиент` (`id_клиента`, `ФИО`, `Телефон`, `email`, `пароль`) VALUES
(1, 'Каюмов Алексей Владимирович', '89064634834', 'kaum@mail.ru', '1234'),
(2, 'Мутко Артем Владимирович', '89064634850', 'mutko@mail.ru', '1234'),
(3, 'Киреев Алексей Владимирович', '89064634840', 'kiriev@mail.ru', '1234'),
(4, 'Суриков Михаил Петрович', '89064634822', 'surikov@mail.ru', '1234');
...
--
ALTER TABLE `материал`
  MODIFY `id_материала` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
