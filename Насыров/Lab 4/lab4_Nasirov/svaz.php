...
<div class="container obr_svyaz">
    <form class="row justify-content-center form-obr-svaz" method="post">
        ...
        <p align="center" style="margin: 0; padding-bottom: 30px">
            <b>Если вы хотите узнавать информацию раньше всех, заполните форму ниже, введя свой email и в сообщение - подписаться, чтобы подписаться на рассылку по почте</b></p>
        <div style="width: 40%; border: 1px solid cornflowerblue; border-radius: 10px">
            <center>
                <div class="w-100"></div>
    ...
    <?php
    if(isset($_POST['send'])){
        mail($_POST['email'], $_POST['msg'], 'From: nasirov@gmail.com');
