...
<div class="container">
    <div class="content row">
        ...
        <div class="main-content col-md-12 col-12">
            <h2>Последние новости из мира IT</h2>
            <?php
            include "connect.php";
            $result = "Select * from Новости order by id_новости DESC";
            ...
            while ($row = mysqli_fetch_assoc($result))
            {
                ...
                $time = date('H:i', $date);
                echo '<div class="news row mb-3">
                        <div class="news img col-md-4 col-12">
                            <img src="'.$row['Изображение'].'" alt="Изображение новости">
                        </div>
                        <div class="news_text col-12 col-md-8">
                            <h3><a href="single_news.php?id='.$row['id_новости'].'">'.$row['Title'].'</a></h3>
                            <p>Автор: '.$row['Author'].' <br>Дата: '.$new_date.'<br>
                            Время: '.$time.'<br>
                            Краткое содержание: '.$row['Краткое описание'].'</p>
                        </div></div>';
            }
            ?>
        </div>
