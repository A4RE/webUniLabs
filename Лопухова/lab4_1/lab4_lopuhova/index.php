    ...
    <div class="content row">
        ...
        <div class="main-content col-8">
            ...
            $result = "Select *, Организатор.ФИО_Организатора from Выставка 
                        INNER JOIN Организатор ON (Выставка.id_организатора = Организатор.id_организатора)";
            ...
            while ($row = mysqli_fetch_assoc($result))
            {
                ...
                echo '<div class="vistavka row">
                        <div style="background: saddlebrown; color: #e1e1e1" class="vistavka_text col-12 row">';
                echo "<div class='col-md-6'>";
                echo '<h3><a href="single.php?id='.$row['id_выставки'].'">Выставка: '.$row['Название'].'</a></h3>
                        <p><i class="bx bx-calendar">Выставка проходит с  </i>'.$newDate1.' по '.$newDate2.'</p>
