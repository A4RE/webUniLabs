...
<div class="container obr_svyaz">
    <form class="row justify-content-center form-obr-svaz" method="post">
        ...
        <p align="center" style="margin: 0; padding-bottom: 30px">
            <b>Если вы хотите получить какую-либо дополнительную информацию,
                то можете заполнить форму ниже и мы пришлем вам ответ в течении пары дней, либо же, позвоните по горячему телефону, указанному ниже
                +79054450733</b></p>
        <div style="width: 40%; border: 1px solid black; border-radius: 10px">
            <center>
                ...
                <div class="mb-3 col-12 col-md-4 btn-reg">
                    <button type="submit" name='send' class="btn btn-primary" style="background: saddlebrown">Отправить</button>
                </div>
            </center>
        </div>
    </form>
    <?php
    if(isset($_POST['send'])){
        mail($_POST['email'], $_POST['theme'], $_POST['msg'], 'From: lopuhova@gmail.com');
