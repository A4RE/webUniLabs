...
<div class="container reg_form">
    <form class="row justify-content-center login" method="post">
        <h2>Форма Входа Администратора</h2>
...
function auth($login, $pass)
{
    ...
    {
        $_SESSION['message'] = '<center><strong><i>Такого админа не найдено</i></strong></center>';
        header('Refresh: 1; URL = admin_login.php');
    }
