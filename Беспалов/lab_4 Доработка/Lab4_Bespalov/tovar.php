...
function print_store($req)
{
    ...
    if ($req) {
        ...
        {
            echo "<input class='btn-lk' type='submit' name='add' value='Добавить'>
                      </form>";
        } else {
            echo "Для того, чтобы сделать заказ, вам необходимо либо <b><br><a class='a-link' href=\"login.php\">Авторизироваться</a> ,либо <a class='a-link' href=\"reg.php\">Зарегистрироваться</a> на нашем сайте";
        }
        if (!empty($_GET['add'])) {
