...
<div class="container obr_svyaz">
    <div class="row justify-content-center form-obr-svaz col-md-12 col-12">
        ...
        <div class="col-12 col-md-6">
            <p style="padding-left: 30px">
                <b>Если у вас есть какие-либо вопросы по работе нашей компании, то можете:<br>
                    1. Обратиться по телефону: +79043440722 <br>
                    2. Обратиться в главный офис компании, находящийся по адресу: г.Санкт-Петербург, ул. Виноградова, д.8<br>
                    3. Заполнить форму
                </b>
            </p>
        </div>
    ...
    <?php
    if(isset($_POST['send'])){
        mail($_POST['theme'], $_POST['email'], $_POST['msg'], 'From: bespalov_maks@gmail.com');
