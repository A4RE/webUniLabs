...
<div class="container">
    <div class="table_uslug">
        <center>
        <h2 align="center" style="margin: 20px 0">Список Услуг</h2>
...
function print_store($req)
{
    ...
    echo "<form metod = 'GET'>";
    if ($req) {
        echo "<center><table class='table'><tr><th>Название услуги</th><th>Стоимость (Р)</th><th>Заказать</th></tr>";
        while ($row_u = mysqli_fetch_assoc($req)) {
            echo "<tr><td>" . $row_u['Наименование_услуги'] . "</td>
                    <td>" . $row_u['Стоимость_услуги'] . "Р</td><td><input type=\"checkbox\" name=\"choices[]\" value = \"" . $row_u['id_услуги'] . "\"></td>
                    </tr>";
        }
        echo "</table></center>
